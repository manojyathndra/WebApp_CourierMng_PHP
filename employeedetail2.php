...
<div class="container"> <form action="employeedetail.php" method="get">

<h2>VIEW EMPLOYEE DETAILS</h2><br/>

<p><b>SEARCH WITH EMPLOYEE ID</b></p>

<div class="form-input"><p>EMPLOYEE ID: </p><input type="text" name="eid" placeholder="Employee ID"/></div>

<input type="submit" name="submit" value="VIEW EMPLOYEE" class="btn"/>
...
<div class="container"> <form action="employeedetail1.php" method="get">

<p><b>GET EMPLOYEE DETAILS WITH BRANCH ID</b></p>
