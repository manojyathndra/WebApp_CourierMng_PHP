...
<div class="container"> <form action="yourcourier.php" method="post">

<h2>VIEW COURIER</h2><br/>

<div class="form-input"><p>ENTER USERNAME: </p><input type="text" name="username" placeholder="Username"/></div>
