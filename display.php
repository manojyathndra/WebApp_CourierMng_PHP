...
<div class="container"> <form action="viewcustomer.php" method="get">

<h2>DISPLAY</h2><br/>
    
<h2>DISPLAY CUSTOMER</h2><br/>

<input type="submit" name="submit" value="ALL CUSTOMER" class="btn"/>

</form></div>

<div class="container"> <form action="viewemp.php" method="get">

<h2>DISPLAY EMPLOYEE</h2><br/>

<input type="submit" name="submit" value="ALL EMPLOYEE" class="btn"/>

</form></div>
<div class="container"> <form action="viewpickup.php" method="get">

<h2>DISPLAY PICKUP</h2><br/>

<input type="submit" name="submit" value="ALL PICKUP" class="btn"/>

</form></div>

<div class="container"> <form action="viewbranch4.php" method="get">

<h2>DISPLAY BRANCH</h2><br/>

<input type="submit" name="submit" value="ALL BRANCH" class="btn"/>

</form></div>

<div class="container"> <form action="viewfb.php" method="get">

<h2>DISPLAY FEEDBACK</h2><br/>

<input type="submit" name="submit" value="ALL FEEDBACK" class="btn"/>
